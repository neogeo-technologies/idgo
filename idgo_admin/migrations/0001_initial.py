# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2019-10-02 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributions', models.ManyToManyField(related_name='profile_contributions', through='idgo_admin.LiaisonsContributeurs', to='idgo_admin.Organisation', verbose_name="Organisation dont l'utilisateur est contributeur")),
                ...
                ('referents', models.ManyToManyField(related_name='profile_referents', through='idgo_admin.LiaisonsReferents', to='idgo_admin.Organisation', verbose_name="Organisation dont l'utilisateur est réferent")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.CharField(blank=True, choices=[('OGC:WMS', 'WMS'), ('OGC:WFS', 'WFS'), ('OGC:WCS', 'WCS'), ('OGC:KML', 'KML'), ('WWW:DOWNLOAD-1.0-http--download', 'Fichier à télécharger'), ('WWW:LINK-1.0-http--link', 'Adresse Internet (URL)'), ('DB:POSTGIS', 'Base de données / Table PostGIS')], max_length=100, null=True, verbose_name='Protocole')),
